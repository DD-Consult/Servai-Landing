...
const features = [
  {
    ...
    description: 'Sophisticated LLM-driven chat interface that handles complex dietary requests and natural language ordering.'
  },
  {
    id: 2,
    icon: 'fingerprint',
    ...
    description: 'Frictionless checkout with Apple Pay, Google Pay, and Face ID integrated directly into the chat flow.'
  },
  {
    id: 3,
    ...
    description: 'Automatically track visits and reward regulars without physical cards or app downloads.'
  },
  {
    id: 4,
    icon: 'dashboard',
    ...
    description: 'Real-time order management, inventory tracking, and deep customer analytics at your fingertips.'
  },
  {
    id: 5,
    icon: 'translate',
    ...
    description: 'Serve international guests in their native language with real-time AI translation capabilities.'
  },
  {
    id: 6,
    icon: 'database',
    ...
    description: 'Reclaim your relationship with customers. No third-party aggregator data lock-in or hidden fees.'
  }
];
    ...
    <div className="App">
      ...
      <section id="impact" className="stats-section">
        <div className="stats-section-inner">
          <h2 className="section-title-centered">Business Impact</h2>
          <div className="stats-grid">
            {[
              { num: '90s', label: 'Average order completion time', sub: 'From QR scan to payment confirmation' },
              { num: '30-50%', label: 'Increase in repeat orders', sub: 'Through built-in loyalty tracking' },
              { num: '100%', label: 'Customer data ownership', sub: 'No aggregator fees or data lock-in' },
              { num: '2B+', label: 'Global WhatsApp reach', sub: 'Your customers already use it daily' }
            ].map((s, i) => (
      ...
      <section className="why-section">
        <div className="why-section-inner">
          <h2 className="section-title-centered">Why ServAI?</h2>
          <div className="comparison-grid">
            <div className="comparison-card old-way">
              <h3 className="comparison-heading old-heading">The Old Way <span>😤</span></h3>
              <ul className="comparison-list">
                {[
                  'Clunky, slow-loading web pages',
                  'Re-entering name, phone & card every time',
                  'High rates of cart abandonment',
                  'Losing customer data to third parties'
                ].map((item, i) => (
            ...
            <div className="comparison-card new-way">
              ...
              <ul className="comparison-list">
                {[
                  'Instant chat on WhatsApp or Messenger',
                  'AI remembers preferences automatically',
                  'Biometric payments in seconds',
                  'You own 100% of your customer data'
                ].map((item, i) => (
                  <li key={i} className="comparison-item new-item">
                    <span className="material-symbols-outlined comparison-icon icon-teal" style={{ fontVariationSettings: '"FILL" 1' }}>check_circle</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
      ...
      {/* ===== FEATURES - INTELLIGENT HOSPITALITY ===== */}
      <section id="features" className="features-section">
        <div className="features-section-inner">
          <h2 className="section-title-centered">Intelligent Hospitality</h2>
            ...
            <div className="how-steps-col">
              ...
              <ol className="steps-list">
                {howItWorksSteps.map((step) => (
                  <li
                    key={step.id}
                    className={`step-card ${activeStep === step.id ? 'active-step' : ''}`}
      ...
      <section id="roi" className="roi-section">
        <div className="roi-section-inner">
          <h2 className="section-title-centered">See Your Potential</h2>
          <p className="section-subtitle">
      ...
      <section className="preview-section">
        <div className="preview-section-inner">
          <span className="preview-label">The Interface</span>
          <h2 className="preview-heading">Experience the Future</h2>
          ...
          {!showSuccess ? (
            ...
            <div className="success-message">
              ...
              <p>
                ...
                to schedule your personalized ServAI demonstration.
              </p>
            </div>
          )}
        </div>
